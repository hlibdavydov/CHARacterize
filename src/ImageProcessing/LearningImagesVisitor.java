...
public class LearningImagesVisitor implements FileVisitor<Path> {
  ...
  public static final int numberOfEachLetterToProcess = 200;
  ...
  public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) throws IOException {
    ...
    Image image = new Image(inputStream,WIDTH_OF_IMAGE,HIGH_OF_IMAGE,false,true);
    char nameOfLetter = file.getParent().getFileName().toString().toUpperCase().charAt(0);
    var pixels = ImageSimplifier.getSimplifiedPixelsArray(image,ImageSimplifier.BLACK_COLOR);
